...
export const birthdayConfig = {
  ...
  letter: [
    ...
    "You're family in your own way — basically the sister I got to choose.",
    "Someone I can laugh with, annoy, argue with, make fun of, and still somehow want around — full sibling privilege, completely voluntary.",
