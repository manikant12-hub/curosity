...
export default function Home() {
  ...
  return <><div className="site-shell">
    ...
    <main>
      ...
      <section id="chapter-1" className="chapter ink-chapter fun-chapter" onMouseEnter={() => setChapter(1)}><div className="chapter-number">02</div><div className="chapter-inner narrow"><p className="eyebrow sea">A LITTLE CHAOS</p><h2>Before I say anything serious<span className="sea">…</span></h2><p className="lede">Apparently you’re an adult now. I’m not convinced. Big-sister energy, zero official paperwork.</p><div className="question-card"><span className="question-count">{pad(questionIndex + 1)} / 05</span><h3>{currentQuestion.prompt}</h3><div className="choice-row">{currentQuestion.options.map(o => <button key={o} className="choice" onClick={() => { setAnswers([...answers, o]); setQuestionIndex(questionIndex + 1); }}>{o}<ArrowRight size={15}/></button>)}</div><p className="answer-note">{response}</p></div></div></section>
