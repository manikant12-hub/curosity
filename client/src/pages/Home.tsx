...
export default function Home() {
  ...
  const revealCake = () => { setCandleOut(true); setSoundOn(true); void audioRef.current?.play().catch(() => undefined); };
